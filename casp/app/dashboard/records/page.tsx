    ...
    return (
        <div className="flex flex-col items-start justify-start w-full h-full px-[20px]">
            ...
            <div className="flex flex-row mt-[5px]">
                <button className="text-[14px] mb-4 bg-black hover:bg-gray-800 text-white font-albert font-bold py-[5px] px-[10px] rounded-[10px]"> add single record</button>
                <button className="text-[14px] ml-4 mb-4 bg-black hover:bg-gray-800 text-white font-albert font-bold py-[5px] px-[10px] rounded-[10px]">add bulk records</button>
            </div>
