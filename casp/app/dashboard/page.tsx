...
export default async function Dashboard() {
  ...
  return (
    <div className="flex flex-row items-center justify-center h-dvh w-full bg-white">
      ...
      <div className="flex flex-col items-center justify-start w-[20%] h-full">
        ...
        <div className="flex flex-col items-start justify-start w-full p-2 gap-1">
          ...
          <div className="flex flex-row items-center justify-start">
            <Image src={addrecord} alt="database icon" width={16} height={16}/>
            <h1 className="text-[15px] font-cal ml-[10px]">add records</h1>
          </div>
          <div className="flex flex-row items-center justify-start">
            <Image src={giveaccess} alt="database icon" width={16} height={16}/>
      ...
      <div className="flex flex-col items-start justify-center w-[30%] h-full border-l-[1px] border-gray-300">
        <h1 className="text-[30px] font-cal leading-[30px] ml-[20px]">Chat with AI <br/> to get your tasks done</h1>
        <p className="text--[10px] font-cal ml-[20px]">powered by gemini</p>
        <div className="fixed bottom-[20px] right-[10px] flex flex-row items-center justify-start shadow-md hover:shadow-lg w-[250px] px-[10px] py-[5px] rounded-[12px] border-[1px] border-gray-300 cursor-pointer">
          ...
          <p className="text-[15px] ml-[5px]">what would you like me do?</p>
        </div>
      </div>
