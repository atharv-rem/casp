      ...
      <div className="w-1/2 h-full flex flex-col items-center justify-center p-8">
        ...
        <form onSubmit={handleLogin} className="w-full max-w-md">
          <div className="mb-4">
            ...
            <input id="email" type="email" placeholder="john.doe@example.com" className="shadow-md border-[1px] border-gray-300 rounded-[10px] w-full py-2 px-3 mb-[20px]"/>

            <label htmlFor="password" className="block text-gray-700 text-[20px] font-inter font-medium mb-2">password</label>
            <input id="password" type="password" placeholder="enter your password" className="shadow-md border-[1px] border-gray-300 rounded-[10px] w-full py-2 px-3"/>

            <button type="submit" className="mt-4 bg-black hover:bg-gray-800 text-white font-inter font-medium py-[5px] px-[10px] rounded-[12px]">Login</button>
          </div>
        </form>
      </div>
    </div>
